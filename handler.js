            ...
            continue
             ...
             m.isCommand = true
                ...
                if (!isPrems && plugin.estrellas && global.db.data.users[m.sender].estrellas < plugin.estrellas * 1) {
                    conn.reply(m.chat, `Te encuentras sin Estrellas 🌟\nUsa *.regalo* para obtener mas gratis.`, m, fake)
                    continue
                }
                let extra = {
                    match,
                ...
                try {
                    ...
                    if (m.estrellas)
                        conn.reply(m.chat, `Usaste *${+m.estrellas}*`, m, fake)
                }
                break
            }
        }
