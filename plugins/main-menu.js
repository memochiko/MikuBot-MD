...
const vid = 'https://files.catbox.moe/4wcnay.jpg';

const defaultMenu = {
  before: `*•:•:•:•:•:•:•:•:•:•☾☼☽•:•.•:•.•:•:•:•:•:•*

"🌑 ¡Hola *%name*! %greeting, Estos son mis comandos."
...
exp: exp - min,
maxexp: xp,
botofc: (conn.user.jid == global.conn.user.jid ? '🌑 BOT OFICIAL' : `🌑 𝚂𝚄𝙱-𝙱𝙾𝚃 𝙳𝙴: Wa.me/${global.conn.user.jid.split`@`[0]}`), 
totalexp: exp,
xp4levelup: max - exp,
...
let img = 'https://files.catbox.moe/4wcnay.jpg'; // valiendo vrg con los links
